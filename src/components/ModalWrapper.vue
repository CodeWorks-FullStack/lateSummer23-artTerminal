<template>
  ...
  <button v-if="showButton" type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" :data-bs-target="'#'+id">
    Launch
  </button>
    ...
    <div :class="`modal-dialog modal-dialog-scrollable modal-dialog-centered modal-${size}`" role="document">
      <div class="modal-content text-light">
        ...
        <div class="modal-header">
          ...
          <slot name="header">
            <div class="d-flex justify-content-end w-100"><i class="mdi mdi-close fs-3 selectable" data-bs-dismiss="modal"></i></div>
          </slot>
        </div>
